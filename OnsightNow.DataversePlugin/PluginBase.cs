...
{
    /// <summary>
    /// Base class for all plug-in classes. This class was auto-generated using the 'pac' command line utility.
    /// 
    ...
    {
        private static IReadOnlyDictionary<string, string> EnvVariables;
        ...
        protected static IReadOnlyDictionary<string, string> GetEnvironmentVariables(ILocalPluginContext context)
        {
            ...
            if (EnvVariables == null)
            {
                lock (Lock)
                {
                    if (EnvVariables == null)
                    {
                        ...
                        var results = context.PluginUserService.RetrieveMultiple(query);
